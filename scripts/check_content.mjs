...
const known=new Set(['chapter-card','api-example','sma-example','sma-formula','bar-question','lab','quiz','downloads','backtest-lab','backtest-intro-lab','drawdown-lab','execution-lab']);
